...
public class Wso2ServiceImpl implements Wso2Service {
	 private final Logger log;
      ...
      //      final String uri = "https://192.168.0.50/api/1.0/devices/name/{name}";
	          ...
	          //  final String uri = "http://springbootaws-env.eba-ttwpzp7t.ap-northeast-1.elasticbeanstalk.com/api/1.0/devices/name/{name}";
	            ...
	            final HttpEntity request = new HttpEntity((MultiValueMap)headers);
	            final ResponseEntity<String> response = (ResponseEntity<String>)restTemplate.exchange("https://swaggerdemo.device42.com/api/1.0/devices/name/{name}", HttpMethod.GET, request, (Class)String.class, new Object[] { name });
	            return response;
	        }
	        catch (Exception e) {
	    ...
	    static {
	        ...
	        Wso2ServiceImpl.D42_BASIC_AUTH_USERNAME = "guest";
	        Wso2ServiceImpl.D42_BASIC_AUTH_PASSWORD = "device42_rocks!";
